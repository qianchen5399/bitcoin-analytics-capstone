...
try:
    from template.regime_conditional_dca_v2 import compute_window_weights, precompute_features
    from template.prelude_template import (
        backtest_dynamic_dca,
        check_strategy_submission_ready,
        load_data,
    ...
    from regime_conditional_dca_v2 import compute_window_weights, precompute_features
    from prelude_template import (
        backtest_dynamic_dca,
        check_strategy_submission_ready,
        load_data,
